package jmaccom.example.grocerylist.Activities.Data;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public long addGrocery(Grocery grocery) {
        ...
        long insertionTime = java.lang.System.currentTimeMillis();
        ContentValues values = new ContentValues();
        values.put(Constants.KEY_GROCERY_ITEM, grocery.getName());
        values.put(Constants.KEY_QTY_NUMBER, grocery.getQuantity());
        values.put(Constants.KEY_DATE_NAME, insertionTime);
    ...
    //Get a Grocery
    public Grocery addGrocery(int id) {
        SQLiteDatabase db = this.getWritableDatabase();
